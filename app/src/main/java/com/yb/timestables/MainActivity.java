...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      final SeekBar timeTablesSeekBar = (SeekBar) findViewById(R.id.timeTablesSeekBar);
        timeTablesListView = (ListView) findViewById(R.id.timesTableListView);
